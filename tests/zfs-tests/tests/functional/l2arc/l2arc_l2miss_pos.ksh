...
log_assert "xxxx l2arc_mfuonly does not cache MRU buffers."
...
log_must zpool create -f $TESTPOOL1 $VDEV1

# to pool without l2arc
export DIRECTORY=/$TESTPOOL1
log_must fio $FIO_SCRIPTS/mkfiles.fio
log_must fio $FIO_SCRIPTS/random_reads.fio

log_must test $(get_arcstat l2_misses) -eq 0
...
log_pass "xxx l2arc_mfuonly does not cache MRU buffers."
